      ...
      <View style={s.body}>
        <View style={s.header}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.65}
            hitSlop={8}
            accessibilityLabel={card.isFavorite ? 'Unpin info card' : 'Pin info card'}
          >
            <Ionicons
              name={card.isFavorite ? 'pin' : 'pin-outline'}
              size={18}
              color={card.isFavorite ? '#F59E0B' : colors.mutedForeground}
            />
          </TouchableOpacity>
        </View>
